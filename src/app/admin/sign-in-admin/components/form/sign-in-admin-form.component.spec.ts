...
import { SignInAdminFormComponent } from './sign-in-form.component';
import { provideMockStore } from '@ngrx/store/testing';
import { of } from 'rxjs';
import { ActivatedRoute } from '@angular/router';

describe('SignInCollaboratorFormComponent', () => {
  let component: SignInAdminFormComponent;
  let fixture: ComponentFixture<SignInAdminFormComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, SignInAdminFormComponent],
      providers: [
        provideMockStore({}),
        {
    ...
    fixture = TestBed.createComponent(SignInAdminFormComponent);
