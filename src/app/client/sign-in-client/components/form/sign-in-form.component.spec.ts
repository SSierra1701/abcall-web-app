...
import { SignInClientFormComponent } from './sign-in-form.component';
import { provideMockStore } from '@ngrx/store/testing';
import { of } from 'rxjs';
import { ActivatedRoute } from '@angular/router';

describe('SignInClientFormComponent', () => {
  let component: SignInClientFormComponent;
  let fixture: ComponentFixture<SignInClientFormComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, SignInClientFormComponent],
      providers: [
        provideMockStore({}),
        {
    ...
    fixture = TestBed.createComponent(SignInClientFormComponent);
