...
import { ClientHomeState } from '../../home-client/type/clientHomeState';
import { clientHomeActions } from '../../home-client/store/clientHomeActions';
...
export const redirectAfterSignUp = createEffect(
  (
    ...
    homeStore = inject(Store<ClientHomeState>)
  ) => {
    return actions$.pipe(
