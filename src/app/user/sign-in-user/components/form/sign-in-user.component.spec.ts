...
import { SignInUserFormComponent } from './sign-in-form.component';
import { provideMockStore } from '@ngrx/store/testing';
import { of } from 'rxjs';
import { ActivatedRoute } from '@angular/router';

describe('SignInUserFormComponent', () => {
  let component: SignInUserFormComponent;
  let fixture: ComponentFixture<SignInUserFormComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, SignInUserFormComponent],
      providers: [
        provideMockStore({}),
        {
    ...
    fixture = TestBed.createComponent(SignInUserFormComponent);
